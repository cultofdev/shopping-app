                ...
                return (
                    <TouchableOpacity
                        ...
                        style={{
                            ...
                            marginHorizontal: 5,
                            marginBottom: 10,
                            backgroundColor: selectedItem.size[index] === selectedSize ? COLORS.white : null,
                            borderWidth: 1,
                    ...
                    >
                        <Text style={{ color: selectedItem.size[index] === selectedSize ? COLORS.black : COLORS.white, ...FONTS.body4 }}>{item}</Text>
                    </TouchableOpacity>
                )
            })
        )
